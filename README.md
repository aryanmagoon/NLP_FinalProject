The proper code that was actually used to train the model can be found on .ipynb files, and to more easily view specific portions of the code, refer to the split python files
